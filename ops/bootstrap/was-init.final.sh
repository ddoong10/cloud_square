...
CORS_ALLOWED_ORIGIN="${CORS_ALLOWED_ORIGIN:-TODO_CORS_ALLOWED_ORIGIN}"
NCP_ACCESS_KEY="${NCP_ACCESS_KEY:-TODO_NCP_ACCESS_KEY}"
NCP_SECRET_KEY="${NCP_SECRET_KEY:-TODO_NCP_SECRET_KEY}"
NCP_BUCKET="${NCP_BUCKET:-TODO_NCP_BUCKET}"
STATIC_BASE_URL="${STATIC_BASE_URL:-TODO_STATIC_BASE_URL}"
...
VOD_STATION_CATEGORY_ID="${VOD_STATION_CATEGORY_ID:-TODO_VOD_STATION_CATEGORY_ID}"
